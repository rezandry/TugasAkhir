# -*- coding: utf-8 -*-
"""
Created on Sun Mar 26 14:33:23 2017
...
pyplot.plot(t, x)
pyplot.title('Filterut - Time Domain')
pyplot.grid(True)
...
pyplot.title('Filterut - Frequency Domain')
...
pyplot.title('Filterquency Response')
...
fig.add_subplot(235)
pyplot.plot(t, y)
pyplot.title('Filterput - Time Domain')
pyplot.grid(True)
...
pyplot.title('Filterput - Frequency Domain')
pyplot.grid(True)
